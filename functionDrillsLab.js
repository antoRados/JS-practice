...
let test = theEliminator(contestants, loser)
console.log(test)
...
//CODE HERE
function makeUpperCase(stringToUpper){
...
//CODE HERE
function buyChocolateFrogs(goldInWallet){
	let frogsBought = (goldInWallet / 3)
	
	return (frogsBought)
}
let totalFrogs = buyChocolateFrogs(32)
...
//CODE HERE
function buyChocolateFrogs2(goldInWallet){
	let frogsBought = parseInt((goldInWallet / 3))
	
	return (frogsBought)
}
let totalFrogs2 = buyChocolateFrogs2(32)
...
//CODE HERE
function someFunction(numsArray){
